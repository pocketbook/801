...
#define MXCFB_SET_BORDER_MODE		_IOW('F', 0x33, __u32)
#define MXCFB_SET_TEMP_AUTO_UPDATE_PERIOD   _IOW('F', 0x34, int32_t)
#define MXCFB_SET_EPD_PWR0_CTRL		_IOR('F', 0x35, int32_t)
#define MXCFB_SET_EPD_PWR2_CTRL		_IOR('F', 0x36, int32_t)
#define MXCFB_GET_PMIC_TEMPERATURE	_IOR('F', 0x37, int32_t)
