...
struct mxc_uor6x5x_platform_data {
	unsigned int irq;	/*!< The power pointer */
};
...
struct mxc_hardware_switch_data{
	int hardware_irq;
	int (*hardware_status) (void);
};

struct mxc_usb_detect_data{
	int usb_irq;
	int (*usbdetect_status) (void);
};

struct mxc_led_detect_data{
	int led_irq;
	int (*leddetect_status) (void);
};
