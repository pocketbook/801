...
#define REG_MODE_0_ALL_MASK (DIG_STBY_MASK | GEN1_STBY_MASK \
	                       | IOHI_STBY_MASK | PLL_STBY_MASK | USB2_STBY_MASK \
	                       /*| GEN2_STBY_MASK*/)
#define REG_MODE_1_ALL_MASK	(CAM_STBY_MASK | VIDEO_STBY_MASK |\
				AUDIO_STBY_MASK | GEN3_STBY_MASK | SD_STBY_MASK)
