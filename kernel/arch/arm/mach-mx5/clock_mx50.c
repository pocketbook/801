...
int __init mx50_clocks_init(unsigned long ckil, unsigned long osc, unsigned long ckih1)
{
	...
	__raw_writel(MXC_ANADIG_CHGR_DETECT_DISABLE, apll_base + MXC_ANADIG_MISC_SET);
	...
	//__raw_writel(3 << MXC_CCM_CCGRx_CG7_OFFSET, MXC_CCM_CCGR2);
