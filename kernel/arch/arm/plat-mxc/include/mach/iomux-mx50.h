...
#define MX50_GPIO_PAD_CTRL    (PAD_CTL_PKE |PAD_CTL_PUE |PAD_CTL_PUS_47K_UP| \
							PAD_CTL_ODE |PAD_CTL_DSE_HIGH)
...
#define MX50_PAD_PWM2__PWMO 	        IOMUX_PAD(0x308, 0x5C, 0, 0x0, 0, NO_PAD_CTRL)
...
/* remove the default keeper from this pad */
...
#define MX50_PAD_EPDC_D8__EPDC_D8	IOMUX_PAD(0x56c, 0x01d0, 0, 0x0, 0, \
						NO_PAD_CTRL)
#define MX50_PAD_EPDC_D9__EPDC_D9	IOMUX_PAD(0x570, 0x01d4, 0, 0x0, 0, \
						NO_PAD_CTRL)
#define MX50_PAD_EPDC_D10__EPDC_D10	IOMUX_PAD(0x574, 0x01d8, 0, 0x0, 0, \
						NO_PAD_CTRL)
#define MX50_PAD_EPDC_D11__EPDC_D11	IOMUX_PAD(0x578, 0x01dc, 0, 0x0, 0, \
						NO_PAD_CTRL)
#define MX50_PAD_EPDC_D12__EPDC_D12	IOMUX_PAD(0x57c, 0x01e0, 0, 0x0, 0, \
						NO_PAD_CTRL)
#define MX50_PAD_EPDC_D13__EPDC_D13	IOMUX_PAD(0x580, 0x01e4, 0, 0x0, 0, \
						NO_PAD_CTRL)
#define MX50_PAD_EPDC_D14__EPDC_D14	IOMUX_PAD(0x584, 0x01e8, 0, 0x0, 0, \
						NO_PAD_CTRL)
#define MX50_PAD_EPDC_D15__EPDC_D15	IOMUX_PAD(0x588, 0x01ec, 0, 0x0, 0, \
						NO_PAD_CTRL)
...
#define MX50_PAD_EPDC_BDR0__EPDC_BDR0	IOMUX_PAD(0x5D8, 0x23C, 0, 0x0, 0, \
							NO_PAD_CTRL)
#define MX50_PAD_EPDC_BDR1__EPDC_BDR1	IOMUX_PAD(0x5DC, 0x240, 0, 0x0, 0, \
							NO_PAD_CTRL)
...
///add///
#define MX50_PAD_OWIRE__SSI_EXT1_CLK	IOMUX_PAD(0x30C, 0x60, 3, 0x0, 0, \
						NO_PAD_CTRL)

//#define MX50_PAD_EPITO__SSI_EXT2_CLK	IOMUX_PAD(0x310, 0x64, 3, 0x0, 0,  \
//						NO_PAD_CTRL)
...
/* wen WVGA */
#define MX50_PAD_DISP_D0_WVGA_DISP_D0	IOMUX_PAD(0x40C, 0x12C, 0, 0x6fc, 0, \
						MX50_WVGA_PAD_CTRL)
#define MX50_PAD_DISP_D1_WVGA_DISP_D1	IOMUX_PAD(0x410, 0x130, 0, 0x700, 0, \
						MX50_WVGA_PAD_CTRL)
#define MX50_PAD_DISP_D2_WVGA_DISP_D2	IOMUX_PAD(0x414, 0x134, 0, 0x704, 0, \
						MX50_WVGA_PAD_CTRL)
#define MX50_PAD_DISP_D3_WVGA_DISP_D3	IOMUX_PAD(0x418, 0x138, 0, 0x708, 0, \
						MX50_WVGA_PAD_CTRL)
#define MX50_PAD_DISP_D4_WVGA_DISP_D4	IOMUX_PAD(0x41C, 0x13C, 0, 0x70c, 0, \
						MX50_WVGA_PAD_CTRL)
#define MX50_PAD_DISP_D5_WVGA_DISP_D5	IOMUX_PAD(0x420, 0x140, 0, 0x710, 0, \
						MX50_WVGA_PAD_CTRL)
#define MX50_PAD_DISP_D6_WVGA_DISP_D6	IOMUX_PAD(0x424, 0x144, 0, 0x714, 0, \
						MX50_WVGA_PAD_CTRL)
#define MX50_PAD_DISP_D7_WVGA_DISP_D7	IOMUX_PAD(0x428, 0x148, 0, 0x718, 0, \
						MX50_WVGA_PAD_CTRL)
#define MX50_PAD_DISP_D8_WVGA_DISP_D8	IOMUX_PAD(0x470, 0x190, 0, 	0x0, 0, \
						MX50_WVGA_PAD_CTRL)
#define MX50_PAD_DISP_D9_WVGA_DISP_D9	IOMUX_PAD(0x474, 0x194, 0, 0x0, 0, \
						MX50_WVGA_PAD_CTRL)
#define MX50_PAD_DISP_D10_WVGA_DISP_D10	IOMUX_PAD(0x478, 0x198, 0, 0x0, 0, \
						MX50_WVGA_PAD_CTRL)
#define MX50_PAD_DISP_D11_WVGA_DISP_D11	IOMUX_PAD(0x47C, 0x19C, 0, 0x0, 0, \
						MX50_WVGA_PAD_CTRL)
#define MX50_PAD_DISP_D12_WVGA_DISP_D12	IOMUX_PAD(0x480, 0x1A0, 0, 0x0, 0, \
						MX50_WVGA_PAD_CTRL)
#define MX50_PAD_DISP_D13_WVGA_DISP_D13	IOMUX_PAD(0x484, 0x1A4, 0, 0x0, 0, \
						MX50_WVGA_PAD_CTRL)
#define MX50_PAD_DISP_D14_WVGA_DISP_D14	IOMUX_PAD(0x488, 0x1A8, 0, 0x0, 0, \
						MX50_WVGA_PAD_CTRL)
#define MX50_PAD_DISP_D15_WVGA_DISP_D15	IOMUX_PAD(0x48C, 0x1AC, 0, 0x0, 0, \
						MX50_WVGA_PAD_CTRL)
#define MX50_PAD_EPDC_GDCLK_WVGA_DISP_D16	IOMUX_PAD(0x58C, 0x1F0, 3, 0x0, 0, \
							MX50_WVGA_PAD_CTRL)
#define MX50_PAD_EPDC_GDSP_WVGA_DISP_D17	IOMUX_PAD(0x590, 0x1F4, 3, 0x0, 0, \
							MX50_WVGA_PAD_CTRL)
#define MX50_PAD_EPDC_GDOE_WVGA_DISP_D18	IOMUX_PAD(0x594, 0x1F8, 3, 0x0, 0, \
							MX50_WVGA_PAD_CTRL)
#define MX50_PAD_EPDC_GDRL_WVGA_DISP_D19	IOMUX_PAD(0x598, 0x1FC, 3, 0x0, 0, \
							MX50_WVGA_PAD_CTRL)
#define MX50_PAD_EPDC_SDCLK_WVGA_DISP_D20	IOMUX_PAD(0x59C, 0x200, 3, 0x0, 0, \
							MX50_WVGA_PAD_CTRL)
#define MX50_PAD_EPDC_SDOEZ_WVGA_DISP_D21	IOMUX_PAD(0x5A0, 0x204, 3, 0x0, 0, \
							MX50_WVGA_PAD_CTRL)
#define MX50_PAD_EPDC_SDOED_WVGA_DISP_D22	IOMUX_PAD(0x5A4, 0x208, 3, 0x0, 0, \
							MX50_WVGA_PAD_CTRL)
#define MX50_PAD_EPDC_SDOE_WVGA_DISP_D23	IOMUX_PAD(0x5A8, 0x20C, 3, 0x0, 0, \
							MX50_WVGA_PAD_CTRL)
#define MX50_PAD_DISP_WR_WVGA_DISP_CLK	IOMUX_PAD(0x42C, 0x14C, 2, 0x0, 0, \
						MX50_WVGA_PAD_CTRL)
#define MX50_PAD_DISP_RD_WVGA_DISP_DE	IOMUX_PAD(0x430, 0x150, 2, 0x0, 0, \
						MX50_WVGA_PAD_CTRL)
#define MX50_PAD_DISP_RS_WVGA_DISP_VSYNC	IOMUX_PAD(0x434, 0x154, 2, 0x73c, 1, \
						MX50_WVGA_PAD_CTRL)
#define MX50_PAD_DISP_CS_WVGA_DISP_HSYNC	IOMUX_PAD(0x438, 0x158, 2, 0x6f8, 1, \
						MX50_WVGA_PAD_CTRL)
...
#define MX50_PAD_EIM_DA7__KEY_ROW7	IOMUX_PAD(0x614, 0x278, 3, 0x7ac, 2, \
						MX50_KEYPAD_CTRL)
/*keypad board*/					
#define MX50_PAD_DISP_D8__KEY_COL4 	IOMUX_PAD(0x470, 0x190, 5, 0x790, 1, MX50_KEYPAD_CTRL)
#define MX50_PAD_DISP_D9__KEY_ROW4 	IOMUX_PAD(0x474, 0x194, 5, 0x7a0, 1, MX50_KEYPAD_CTRL)
#define MX50_PAD_DISP_D10__KEY_COL5	IOMUX_PAD(0x478, 0x198, 5, 0x794, 1, MX50_KEYPAD_CTRL)
#define MX50_PAD_DISP_D11__KEY_ROW5	IOMUX_PAD(0x47C, 0x19C, 5, 0x7a4, 1, MX50_KEYPAD_CTRL)
#define MX50_PAD_DISP_D12__KEY_COL6	IOMUX_PAD(0x480, 0x1A0, 5, 0x798, 1, MX50_KEYPAD_CTRL)
#define MX50_PAD_DISP_D13__KEY_ROW6	IOMUX_PAD(0x484, 0x1A4, 5, 0x7a8, 1, MX50_KEYPAD_CTRL)
#define MX50_PAD_DISP_D14__KEY_COL7	IOMUX_PAD(0x488, 0x1A8, 5, 0x79c, 1, MX50_KEYPAD_CTRL)
#define MX50_PAD_DISP_D15__KEY_ROW7	IOMUX_PAD(0x48C, 0x1AC, 5, 0x7ac, 1, MX50_KEYPAD_CTRL)
