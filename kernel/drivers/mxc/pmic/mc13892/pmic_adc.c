...
#define PMIC_ADC_DEV_NAME  "mc13892_adc"
...
static int mc13892_pmic_adc_suspend(struct platform_device *pdev, pm_message_t state)
{
	suspend_flag = 1;
...
static int mc13892_pmic_adc_resume(struct platform_device *pdev)
{
...
static struct pmic_adc_api pmic_mc13892adc_api = {
...
static int mc13892_pmic_adc_module_probe(struct platform_device *pdev)
{
	int ret = 0;
	...
	pmic_adc_ready = 1;
	register_adc_apis(&pmic_mc13892adc_api);
...
static int mc13892_pmic_adc_module_remove(struct platform_device *pdev)
{
	mc13892_adc_deinit();
	pmic_adc_ready = 0;
...
static struct platform_driver pmic_adc_driver_ldm = {
	.driver = {
		   .name = PMIC_ADC_DEV_NAME,
		   },
	.suspend = mc13892_pmic_adc_suspend,
	.resume = mc13892_pmic_adc_resume,
	.probe = mc13892_pmic_adc_module_probe,
	.remove = mc13892_pmic_adc_module_remove,
};
