 ...
 */
static struct platform_device pmic_spi_adc_ldm = {
	.name = "pmic_adc",
	.id = 1,
};
static struct platform_device pmic_spi_battery_ldm = {
	.name = "pmic_battery",
	.id = 1,
};
static struct platform_device pmic_spi_power_ldm = {
	.name = "pmic_power",
	.id = 1,
};
static struct platform_device pmic_spi_rtc_ldm = {
	.name = "pmic_rtc",
	.id = 1,
};
static struct platform_device pmic_spi_light_ldm = {
	.name = "pmic_light",
	.id = 1,
};
static struct platform_device pmic_spi_rleds_ldm = {
	.name = "pmic_leds",
	.id = 'r',
};
static struct platform_device pmic_spi_gleds_ldm = {
	.name = "pmic_leds",
	.id = 'g',
};
static struct platform_device pmic_spi_bleds_ldm = {
	.name = "pmic_leds",
	.id = 'b',
};
...
#else
#error we need choice the pmic mode
#endif
/*
 * External functions
 */
...
static void pmic_pdev_register(void)
{
	platform_device_register(&pmic_spi_adc_ldm);
	platform_device_register(&pmic_spi_battery_ldm);
	platform_device_register(&pmic_spi_rtc_ldm);
	platform_device_register(&pmic_spi_power_ldm);
	platform_device_register(&pmic_spi_light_ldm);
	platform_device_register(&pmic_spi_rleds_ldm);
	platform_device_register(&pmic_spi_gleds_ldm);
	platform_device_register(&pmic_spi_bleds_ldm);
}
...
static void pmic_pdev_unregister(void)
{
	platform_device_unregister(&pmic_spi_adc_ldm);
	platform_device_unregister(&pmic_spi_battery_ldm);
	platform_device_unregister(&pmic_spi_rtc_ldm);
	platform_device_unregister(&pmic_spi_power_ldm);
	platform_device_unregister(&pmic_spi_light_ldm);
}
