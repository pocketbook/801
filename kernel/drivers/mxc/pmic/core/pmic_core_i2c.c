				...
				const struct i2c_device_id *id)
{
	...
	printk("%s %s %d adc_ldm.name =%s\n",__FILE__,__func__,__LINE__,adc_ldm.name); 
	printk("%s %s %d battery_ldm.name =%s\n",__FILE__,__func__,__LINE__,battery_ldm.name); 
	printk("%s %s %d light_ldm.name =%s\n",__FILE__,__func__,__LINE__,light_ldm.name); 
	printk("%s %s %d rtc_ldm.name =%s\n",__FILE__,__func__,__LINE__,rtc_ldm.name); 
