...
//extern void Encryp_main(void);
//extern int EncrypICCheck(int x);
int mma7660_enter_suspend(void);
...
//#define POLL_INTERVAL		100
//#define MMA7660_MAXVALUE    512/*512*/
//#define MMA7660_MINVALUE     (-512)
//#define INPUT_FUZZ	4
//#define INPUT_FLAT	4
#include <linux/input-polldev.h>
...
{
	//printk(KERN_INFO "Linda mma7660_dev_poll 11111111111111111111111111111111\n");
	report_abs();
} 
/////////////////////////end//////
...
static int __init mma7660_init(void)
{
	...
	printk(KERN_DEBUG"add mma7660 i2c driver\n");
...
{
	printk(KERN_DEBUG "remove mma7660 i2c driver.\n");
