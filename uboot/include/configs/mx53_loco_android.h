...
//		"vga=setenv bootargs ${bootargs} init=/init " \
//		"androidboot.console=ttymxc0 di1_primary video=mxcdi1fb:GBR24,VGA-XGA vga\0" \
//		"lcd=setenv bootargs ${bootargs} init=/init " \
//		"androidboot.console=ttymxc0 di0_primary calibration\0" \
//		"hdmi=setenv bootargs ${bootargs} init=/init " \
//		"androidboot.console=ttymxc0 video=mxcdi0fb:RGB24,1080P60 tve gpu_memory=256M\0"	\
//		"claa_lcd=setenv bootargs ${bootargs} init=/init " \
//		"androidboot.console=ttymxc0 video=mxcdi0fb:RGB565,CLAA-WVGA calibration\0" \
//		"bootargs_android=setenv bootargs ${bootargs} init=/init " \
//		"androidboot.console=ttymxc0 di0_primary calibration\0"			\
...
#define	CONFIG_EXTRA_ENV_SETTINGS \
	  ...
	  "bootcmd_SD= mmc read 0 ${loadaddr} 0x800 0x2000; mmc read 0 ${rd_loadaddr} 0x3000 0x300;\0"\
	  "bootargs=setenv bootargs console=ttymxc0 init=/init androidboot.console=ttymxc0 video=mxcdi0fb:RGB24,XGA ldb=di0 di0_primary gpu_nommu,gpu_memory=64M\0"

        //"bootargs=setenv bootargs console=ttymxc0 init=/init androidboot.console=ttymxc0 video=mxcdi0fb:RGB24,CLAA-WVGA,800x600M@57 di0_primary gpu_nommu,gpu_memory=64M\0"
	//"bootargs=setenv bootargs console=ttymxc0 init=/init androidboot.console=ttymxc0 video=mxcdi0fb:RGB24,XGA ldb=di0 di0_primary gpu_nommu,gpu_memory=64M\0"
...
#define CONFIG_ZT2083_CHARGEMEASURE 		  1 //I2C transmit
 ...
 * Physical Memory Map
 */
#define CONFIG_NR_DRAM_BANKS	2		/* Loco board has 2 Chip Select */
#define PHYS_SDRAM_1		CSD0_BASE_ADDR
#define PHYS_SDRAM_1_SIZE	(512 * 1024 * 1024)
#define PHYS_SDRAM_2		CSD1_BASE_ADDR
#define PHYS_SDRAM_2_SIZE	   0/*(512 * 1024 * 1024)*/
